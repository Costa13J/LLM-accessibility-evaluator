...
with open("results_3.3.3.json", "r", encoding="utf-8") as f:
    data = json.load(f)
...
benchmarks = {
    ...
    "https://www.staples.pt/pt/pt/registo": {
        ...
        "Eu concordo com os Termos e Condições da Staples e todos os outros Termos e Políticas que possam ser aplicáveis. (checkbox)": "inapplicable"
    },
    ...
    "https://uh.edu/undergraduate-admissions/apply/index":{
        ...
        "Email Address": "fail",
        "Mobile Phone Number": "inapplicable",
    ...
    "https://www.zomato.com/deliver-food/":{
        "Please enter phone number": "fail",
...
with open("results_with_benchmarks_3.3.3.json", "w", encoding="utf-8") as f:
